...
public class Camera {
    ...
    public ScreenPoint worldToScreen(Vector worldPos) {
        int screenX = (int) (worldPos.x() * scale);
        int screenY = screenHeight - (int) (worldPos.y() * scale);
    ...
    public ScreenPointDouble worldToScreenDouble(Vector worldPos) {
        double screenX = worldPos.x() * scale;
        double screenY = screenHeight - (worldPos.y() * scale);
     ...
     */
    public record ScreenPointDouble(double x, double y) {
    }
}
